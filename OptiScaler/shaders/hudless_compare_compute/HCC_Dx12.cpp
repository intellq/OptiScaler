...
HCC_Dx12::HCC_Dx12(std::string InName, ID3D12Device* InDevice) : Shader_Dx12(InName, InDevice)
{
    ...
    if (Config::Instance()->UsePrecompiledShaders.value_or_default())
    {
        ...
        computePsoDesc.CS = CD3DX12_SHADER_BYTECODE(reinterpret_cast<const void*>(HCC_cso), sizeof(HCC_cso));
    ...
    else
    {
        ...
        if (!Shader_Dx12::CreateComputeShader(
                ...
                CD3DX12_SHADER_BYTECODE(reinterpret_cast<const void*>(HCC_cso), sizeof(HCC_cso))))
        {
